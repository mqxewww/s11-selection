...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= $_ENV["PATH_TO_INDEX"] . "assets/images/icones8-favicon.png" ?>" />
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@mdi/font@6.5.95/css/materialdesignicons.min.css" />
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Questrial&display=swap" />
  <link rel="stylesheet" href="<?= $_ENV["PATH_TO_INDEX"] . "assets/css/style.css" ?>" />
