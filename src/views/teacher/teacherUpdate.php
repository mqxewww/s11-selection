...
<div class="column is-12">
  ...
  <!-- Header -->
  <h3 class="title has-text-black">[S11] Selection BTS - Espace Professeur - Modification</h3>
  <hr class="login-hr">
    ...
    <div class="column">
      <form action="" method="POST" class="box">
        <div class="field">
          ...
          <div class="control">
            <input class="input is-medium" name="modGridNum" value=<?= $grid->getNumber() ?> type="text" placeholder="#ID" required />
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="control">
            <input class="input is-medium" name="modGridName" value=<?= $grid->getName() ?> type="text" placeholder="Nom" required />
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="control">
            <input class="input is-medium" name="modGridFirstname" value=<?= $grid->getFirstname() ?> type="text" placeholder="Prénom" required />
          </div>
        </div>
